...
<head>
    ...
    <title>Delete Branch - Student Management System</title>
    ...
    <div class="container">
        ...
        <main>
            <div class="form-container">
                <form method="POST" action="${pageContext.request.contextPath}/branch/delete" class="form">
                    <h3>Delete Branch</h3>
                    <p class="warning">Warning: This action cannot be undone.</p>
                    
                    <div class="form-group">
                        <label for="branchId">Select Branch to Delete:</label>
